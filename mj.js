$(document).ready(function (){  
    var Validation = (function (){
        ...
        var digitReg = /^\d+$/;
        var passReg=/^((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/; 
        var isPass=function(pass){
    ...
    $('#submit').on('click', function (){
        ...
        pass.each(function (){
            if(!Validation.isPass($(this).val())){
                $(this).siblings('small.errorPass').show();
            }
        });
         pass.each(function (){
            if(!Validation.isPass($(this).val())){
                $(this).siblings('small.errorCha').show();
            }
        });
